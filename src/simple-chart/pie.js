...
"use strict";
eval("\nvar __extends = (this && this.__extends) || (function () {\n    var extendStatics = function (d, b) {\n        extendStatics = Object.setPrototypeOf ||\n            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||\n            function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };\n        return extendStatics(d, b);\n    };\n    return function (d, b) {\n        extendStatics(d, b);\n        function __() { this.constructor = d; }\n        d.prototype = b === null ? Object.create(b) : (__.prototype = b.prototype, new __());\n    };\n})();\nvar __read = (this && this.__read) || function (o, n) {\n    var m = typeof Symbol === \"function\" && o[Symbol.iterator];\n    if (!m) return o;\n    var i = m.call(o), r, ar = [], e;\n    try {\n        while ((n === void 0 || n-- > 0) && !(r = i.next()).done) ar.push(r.value);\n    }\n    catch (error) { e = { error: error }; }\n    finally {\n        try {\n            if (r && !r.done && (m = i[\"return\"])) m.call(i);\n        }\n        finally { if (e) throw e.error; }\n    }\n    return ar;\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar chart_1 = __importDefault(__webpack_require__(/*! ./chart */ \"./app/chart/chart.ts\"));\nvar index_1 = __webpack_require__(/*! ./shape/index */ \"./app/chart/shape/index.ts\");\nvar tool_1 = __webpack_require__(/*! ../utils/tool */ \"./app/utils/tool.ts\");\nvar ChartBar = (function (_super) {\n    __extends(ChartBar, _super);\n    function ChartBar(option, stage2d) {\n        var _this = _super.call(this) || this;\n        _this.option = option;\n        _this.stage2d = stage2d;\n        _this.type = option.type;\n        _this.initOptions();\n        _this.setBar();\n        return _this;\n    }\n    ChartBar.prototype.initOptions = function () {\n        var _this = this;\n        this.initStyle();\n        var _a = this, option = _a.option, stage2d = _a.stage2d, style = _a.style;\n        if (option.padding) {\n            this.padding = option.padding;\n        }\n        var _b = __read(this.paintAxis(option.data), 2), floor = _b[0], ceil = _b[1];\n        this.shapes = [];\n        var createBar = function (value, index) {\n            var shape = new index_1.Bar();\n            shape.stage2d = _this.stage2d;\n            shape.chart2d = _this;\n            shape.pattern = style.colors[index];\n            shape.mouseOverPattern = tool_1.lighten(style.colors[index]);\n            shape.name = option.legend[index];\n            shape.value = value;\n            return shape;\n        };\n        if (option.data && option.data.length) {\n            option.data.forEach(function (item, index) {\n                var group = Array.isArray(item) ? item : [item];\n                _this.shapes.push(group.map(function (v, i) {\n                    return createBar(v, i);\n                }));\n            });\n        }\n        this.initLegend();\n    };\n    ChartBar.prototype.setBar = function () {\n        var _this = this;\n        var _a = this, option = _a.option, stage2d = _a.stage2d;\n        var width = stage2d.width - this.padding[1] - this.padding[3];\n        var height = stage2d.height - this.padding[0] - this.padding[2];\n        var data = this.shapes.map(function (shapes) {\n            return shapes.filter(function (shape) { return !shape.disabled; }).map(function (shape) { return shape.value; });\n        });\n        var _b = __read(this.paintAxis(data), 2), floor = _b[0], ceil = _b[1];\n        var groupWidth = width / option.data.length;\n        this.shapes.forEach(function (shapes, index) {\n            var groupLength = shapes.reduce(function (t, v) {\n                t += v.disabled ? 0 : 1;\n                return t;\n            }, 0);\n            shapes\n                .filter(function (shape) {\n                if (shape.disabled) {\n                    shape.animate({\n                        width: 0\n                    });\n                }\n                return !shape.disabled;\n            })\n                .forEach(function (shape, groupIndex) {\n                var partWidth = groupWidth * 0.8 / groupLength;\n                var h = (shape.value - floor) / (ceil - floor) * height;\n                var w = partWidth * 0.8;\n                var x = (partWidth * groupIndex) + (partWidth * 0.1) + (groupWidth * index) + _this.padding[3] + groupWidth * 0.1;\n                var y = height + _this.padding[0] - 1;\n                shape.y = height + _this.padding[0] - 1;\n                shape.animate({\n                    width: w,\n                    height: h,\n                    x: x,\n                    y: y\n                });\n            });\n        });\n    };\n    return ChartBar;\n}(chart_1.default));\nexports.default = ChartBar;\n\n\n//# sourceURL=webpack://simple-chart/./app/chart/chartBar.ts?");
